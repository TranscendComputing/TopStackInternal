...
public class Trigger {
	...
	/**
	 * Contains the standard unit associated with a measure; used by the trigger
	 * when fetching the metric statistics it uses to determine when to
	 * activate.
	 * <p>
	 * <b>Constraints:</b><br/>
	 * <b>Pattern:
	...
	/**
	 * Specifies the amount of time to wait while the trigger is firing before
	 * performing scaling activities in response to the breach.
	 * <p>
	 * <b>Constraints:</b><br/>
	 ...
	 * <br/>
	 * 
	 * @return Contains the name of the <a>AutoScalingGroup</a> to which the
	 *         trigger belongs.
	 */
	 ...
	 * <b>Length: </b>1 - <br/>
	 * 
	 * @return Contains the dimensions used to retrieve metric statistics that
	 *         the trigger uses to determine when to fire.
	 */
	 ...
	 * <br/>
	 * 
	 * @return Contains the measure name used by the trigger to determine when
	 *         to fire.
	 */
	 ...
	 * trigger to determine when to fire.
	 * 
	 * @return Specifies the period used in retrieving metric statistics used by
	 *         the trigger to determine when to fire.
	 */
	 ...
	 * <b>Pattern: </b>(Average|Sum|Minimum|Maximum)<br/>
	 * 
	 * @return Contains the statistic used by the trigger to determine which
	 ...
	 *         trigger when fetching the metric statistics it uses to determine
	 *         when to activate.
	 */
	 ...
	 *            Contains the name of the <a>AutoScalingGroup</a> to which the
	 *            trigger belongs.
	 */
	 ...
	 *            Specifies the amount of time to wait while the trigger is
	 *            firing before performing scaling activities in response to the
	 *            breach.
	 */
	 ...
	 * 
	 * @param dimensions
	 *            Contains the dimensions used to retrieve metric statistics
	 *            that the trigger uses to determine when to fire.
	 */
	 ...
	 *            Specifies the incremental amount to use when performing
	 *            scaling activities when the lower threshold has been breached.
	 */
	 ...
	 * 
	 * @param measureName
	 *            Contains the measure name used by the trigger to determine
	 *            when to fire.
	 */
	 ...
	 * 
	 * @param period
	 *            Specifies the period used in retrieving metric statistics used
	 *            by the trigger to determine when to fire.
	 */
	 ...
	 * 
	 * @param statistic
	 *            Contains the statistic used by the trigger to determine which
	 *            metric statistics to examine.
	 */
	 ...
	 * 
	 * @param unit
	 *            Contains the standard unit associated with a measure; used by
	 *            the trigger when fetching the metric statistics it uses to
	 ...
	 *            Specifies the incremental amount to use when performing
	 *            scaling activities when the upper threshold has been breached.
	 */
	 ...
	 *         chained together.
	 */
	public Trigger withLowerBreachScaleIncrement(
	 ...
	 *         chained together.
	 */
	public Trigger withUpperBreachScaleIncrement(
