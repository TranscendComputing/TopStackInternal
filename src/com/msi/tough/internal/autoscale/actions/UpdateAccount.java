...
public class UpdateAccount extends UnsecuredAction {
    ...
    public String process0(final Session s, final HttpServletRequest req,
        ...
        final String email = map.get("Email") != null ? map.get("Email")[0]
                : null;
        final String roleName = map.get("RoleName") != null ? map
                .get("RoleName")[0] : null;
        final boolean enabled = map.get("Enabled") != null ? Boolean
                .valueOf(map.get("Enabled")[0]) : null;
        ...
        if (!defName.equalsIgnoreCase(keyName)) {
            ...
            try {
                KeyPairUtils.createKeyPair(AccountUtil.toAccount(ac), ctx,
                        null, "__" + StringHelper.randomStringFromTime(),
